...
namespace ARNavExperiment.Presentation.Glass
{
    public class ConfidenceRatingUI : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            {
                panel = gameObject;
                Debug.LogWarning("[ConfidenceRatingUI] panel null — self-wired to gameObject");
            }
            ...
            Debug.LogWarning($"[ConfidenceRatingUI] Awake — panel={panel != null}, promptText={promptText != null}, " +
